...
from greenhouse_flow_matching_policy.workspace.base_workspace import BaseWorkspace
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run a trained rectified-flow policy on the SCARA setup."
    )
...
def main() -> None:
    ...
    try:
        ...
        for chunk_index in range(args.chunks):
            ...
            if args.show_camera:
                cv2.imshow("SCARA Flow Matching Policy", preview_image(history[-1][0])[..., ::-1])
