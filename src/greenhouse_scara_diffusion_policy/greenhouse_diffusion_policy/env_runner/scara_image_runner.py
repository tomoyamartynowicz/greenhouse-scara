...
from greenhouse_diffusion_policy.dataset.scara_image_dataset import ScaraImageDataset
...
class ScaraImageRunner(BaseImageRunner):
    ...
    def __init__(
        ...
        dataset = ScaraImageDataset(
            ...
            action_source=action_source, action_offset=action_offset, allow_single_episode=allow_single_episode,
        )
