...
import greenhouse_scara_3d_common.vendor.maniflow.model.vision_3d.point_process as point_process
...
class DP3Encoder(nn.Module):
    def __init__(self, 
        ...
        if self.downsample_points:
            ...
            self.num_points = self.point_cloud_shape[0]  # shape is [N, C]; diagnostic count when FPS is disabled
